...
为了解决UE4SS和Mod安装步骤过于繁琐的问题，我开发了 [R-Type Final 2 Mod 管理器](https://github.com/BLACKujira/RTF2ModManager) ，这是一个用于简化 R-Type Final 2 Mod 安装流程的图形化管理工具，支持自动识别游戏目录、安装 UE4SS 以及一键管理常用 Mod。
