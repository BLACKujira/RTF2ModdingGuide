...
在这个教程中，我们将学习如何安装开发者版本的 `UE4SS v3.0.1`，之后验证安装，并排除可能的问题。  
...
## 下载UE4SS
首先进入 [UE4SS-RE/RE-UE4SS](https://github.com/UE4SS-RE/RE-UE4SS) ，点击页面右侧的 [Releases](https://github.com/UE4SS-RE/RE-UE4SS/releases)，下载 `zDEV-UE4SS_v3.0.1.zip` 。
...
## 安装 UE4SS v3.0.1
将 `zDEV-UE4SS_v3.0.1.zip` 中的内容全部解压至此，如果操作正确，文件夹的样子将如图所示。
